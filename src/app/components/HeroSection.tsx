...
const HeroSection = () => {
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:gap-12 sm:grid-cols-12">
        <motion.div
        ...
        >
          <div className="mt-12 sm:mt-0 rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image

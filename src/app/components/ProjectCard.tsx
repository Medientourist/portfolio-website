      ...
      >
        <div className="overlay flex items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          ...
          <Link
            ...
            href={previewUrl}
          >
            <EyeIcon className="w-10 h-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer hover:white" />
          </Link>
        </div>
      </div>
      <div className="rounded-b-xl mt-3 bg-[#181818] px-4 py-6">
